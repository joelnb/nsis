...
<tr>
	...
	<tr class="header"> 
		<td width="70"><a href="index.php"><img class="center" border="0" src="images/logo.gif" width="48" height="48"></a></td> 
		<td width="650"><div align="center" class="header"><? echo $title; if ($showback) _BackButton(); ?></div></td> 
	</tr> 
	<tr> 
		<td colspan="2">
		<div class="margin"> 
