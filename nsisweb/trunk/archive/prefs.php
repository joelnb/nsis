...
echo '<font style="font-family:verdana;font-size:20pt;color:#000000;">Your Preferences</font>';
...
if($session->is_anonymous()) {
	...
	<font style="font-family:verdana;font-size:15pt;color:#000000;">Persistent Login</font>
	<?
	if($user->persists()) {
		print <<<ENDOFHTML
